...
const exoenseOne = store.dispatch(addExpense({ description: 'Rent', amount: 299, createdAt: -21000 }));
const exoenseTwo = store.dispatch(addExpense({ description: 'Coffe', amount: 300, createdAt: -1000 }));
